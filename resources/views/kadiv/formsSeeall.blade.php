        ...
        <div class="container-fluid spark-screen">
            <div class="row">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" min="1" id="qty{{$barang->id_barang}}" name="qty[{{ $barang->id_barang }}]" placeholder="Jumlah Barang/Jasa" class="form-control qty qty'+i+'" oninput="calculate();" value="{{ $barang->jumlah_brg }}" disabled="disabled">
                                                </td>
                                                <td>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group text">
                                        ...
                                        <select name="id_pegawai" class="form-control select2" disabled="disabled">
                                            @foreach($pegawai as $key)
                                            <option value="{{$key->id_pegawai}}" {{$prosespengadaan->id_pegawai == $key->id_pegawai ? 'selected' : null}}> {{$key->namapegawai}}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group text">
                                        ...
                                        <input type="text" name="p_tglspph" class="form-control" placeholder="Tgl. Spph" id="tglspph" value="{{$prosespengadaan->tgl_spph}}" disabled="disabled">
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group text">
                                    ...
                                    <input type="text" name="p_tgletp" class="form-control" placeholder="Tgl. Etp" id="tgletp" value="{{$prosespengadaan->tgl_etp}}" disabled="disabled">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group text">
                                    ...
                                    <input type="text" name="p_tglpmn" class="form-control" placeholder="Tgl. Pengumuman" id="tglpmn" value="{{$prosespengadaan->tgl_pmn}}" disabled="disabled">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group text">
                                    ...
                                    <input type="text" name="p_tglkon" class="form-control" placeholder="Tgl. Kontrak" id="tglkon" value="{{$prosespengadaan->tgl_kon}}" disabled="disabled">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group text">
                                    ...
                                    <input type="text" name="p_nokon" class="form-control" id="inputPassword3" placeholder="No. Ppbj" value="{{$prosespengadaan->no_kon}}" disabled="disabled">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-footer">
                    <button type="submit" name="simpan" class="btn btn-primary pull-right"><i class="fa fa-angle-double-left"></i>&nbsp;Kembali</button>
                </div>
            </div>
        </div>
    </div>
