                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-1 control-label">Kode PJ</label>
                                <div class="col-sm-3">
                                ...
                                <label class="col-sm-1 control-label">No. Registrasi Umum</label>
                                <div class="col-sm-3">
                                    <div class="input-group text">
                                        <div class="input-group-addon">
                                            <i class="fa fa-apple"></i>
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label">Tgl. Registrasi</label>
                                <div class="col-sm-3">
                                    <div class="input-group text">
                                        <div class="input-group-addon">
                                ...
                                <label class="col-sm-1 control-label">Tgl. Permintaan</label>
                                <div class="col-sm-3">
                                    <div class="input-group text">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
